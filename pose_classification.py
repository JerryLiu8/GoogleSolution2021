...
def classify(filename):
    ...
    pose_samples_folders = ['fitness_poses_csvs_out_pushups','fitness_poses_csvs_out_lunges','fitness_poses_csvs_out_squats']
    ...
    pushup_counts, lunge_counts, squat_counts = all_repetition_counts[0], all_repetition_counts[1], all_repetition_counts[2]
